...
class SkillUpdateDto(object):
    ...
    def __init__(self, id=None, nested_skills=None, parent_skills=None, repository_id=None, name=None, level=None, description=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this SkillUpdateDto.  # noqa: E501


        :return: The id of this SkillUpdateDto.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SkillUpdateDto.


        :param id: The id of this SkillUpdateDto.  # noqa: E501
        :type: str
        """
        if id is None:
