...
class LearningProfilesApi(object):
    ...
    def learning_profile_controller_patch_learning_profile_by_id(self, body, **kwargs):  # noqa: E501
        """learning_profile_controller_patch_learning_profile_by_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.learning_profile_controller_patch_learning_profile_by_id(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.learning_profile_controller_patch_learning_profile_by_id_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.learning_profile_controller_patch_learning_profile_by_id_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def learning_profile_controller_patch_learning_profile_by_id_with_http_info(self, body, **kwargs):  # noqa: E501
        """learning_profile_controller_patch_learning_profile_by_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.learning_profile_controller_patch_learning_profile_by_id_with_http_info(body, async_req=True)
        >>> result = thread.get()
