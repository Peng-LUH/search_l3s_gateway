...
=======
    def get_get_raw_task(self, task_id, **kwargs):  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        """Retrieve a Task resource  # noqa: E501
...
=======
        >>> thread = api.get_get_raw_task(task_id, async_req=True)
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        >>> result = thread.get()
...
=======
            return self.get_get_raw_task_with_http_info(task_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_get_raw_task_with_http_info(task_id, **kwargs)  # noqa: E501
            return data

    def get_get_raw_task_with_http_info(self, task_id, **kwargs):  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        """Retrieve a Task resource  # noqa: E501
...
=======
        >>> thread = api.get_get_raw_task_with_http_info(task_id, async_req=True)
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_get_raw_task" % key
                )
            params[key] = val
        del params['kwargs']
...
=======
            raise ValueError("Missing the required parameter `task_id` when calling `get_get_raw_task`")  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
...
=======
    def get_get_raw_task_steps(self, taskstep_id, **kwargs):  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        """Retrieve a TaskStep Resource  # noqa: E501
...
=======
        >>> thread = api.get_get_raw_task_steps(taskstep_id, async_req=True)
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        >>> result = thread.get()
...
=======
            return self.get_get_raw_task_steps_with_http_info(taskstep_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_get_raw_task_steps_with_http_info(taskstep_id, **kwargs)  # noqa: E501
            return data

    def get_get_raw_task_steps_with_http_info(self, taskstep_id, **kwargs):  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        """Retrieve a TaskStep Resource  # noqa: E501
...
=======
        >>> thread = api.get_get_raw_task_steps_with_http_info(taskstep_id, async_req=True)
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_get_raw_task_steps" % key
                )
            params[key] = val
        del params['kwargs']
...
=======
            raise ValueError("Missing the required parameter `taskstep_id` when calling `get_get_raw_task_steps`")  # noqa: E501
>>>>>>> ebc085ac2e497beb2b7e5986f671123b931ecedf
        ...
        return self.api_client.call_api(
            '/aims/get-tasksteps/{taskstep_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
