...
class DtoDatasetList(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """DtoDatasetList - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this DtoDatasetList.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this DtoDatasetList.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DtoDatasetList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DtoDatasetList):
            return False
