...
class DatasetProcessorApi(object):
    ...
    def get_mls_content_type_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset-processor/mls-content-type', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_generate_mls_dataset(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param DtoMlsDataset body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_generate_mls_dataset_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset-processor/mls-corpus', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_json_to_jsonl(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param DtoDatasetRequest body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_json_to_jsonl_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset-processor/json-to-jsonl-converter', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_mls_response_dataset(self, body, **kwargs):  # noqa: E501
        """post_mls_response_dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_mls_response_dataset(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_mls_response_dataset_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_mls_response_dataset_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_mls_response_dataset_with_http_info(self, body, **kwargs):  # noqa: E501
        """post_mls_response_dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_mls_response_dataset_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_mls_response_dataset" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_mls_response_dataset`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset-processor/mls-response-dataset', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_mls_response_object(self, body, **kwargs):  # noqa: E501
        """post_mls_response_object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_mls_response_object(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DtoMlsObject body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_mls_response_object_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_mls_response_object_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_mls_response_object_with_http_info(self, body, **kwargs):  # noqa: E501
        """post_mls_response_object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_mls_response_object_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_mls_response_object" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_mls_response_object`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset-processor/mls-response-object', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
